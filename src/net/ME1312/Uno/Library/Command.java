...
import net.ME1312.Uno.Library.Exception.IllegalStringValueException;
...
public abstract class Command {
    ...
    public void register(String... handles) {
        for (String handle : handles) UnoServer.getInstance().commands.put(handle.toLowerCase(), this);
    }
}
